...
def main():
    ...
    arrivals = pd.read_csv('sim2/arrival_data.csv')
    ...
    arrival_df.to_csv('sim2/arrival_data_FIFO.csv', index=False)
    healing_df.to_csv('sim2/healing_data_FIFO.csv', index=False)
    left_df.to_csv('sim2/left_without_care_data_FIFO.csv', index=False)
